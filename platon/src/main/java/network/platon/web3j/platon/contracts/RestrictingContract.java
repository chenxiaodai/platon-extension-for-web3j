...
public class RestrictingContract extends BaseContract {
    ...
    protected RestrictingContract(String contractAddress, Web3j web3j) {
        super(contractAddress, web3j);
    }

    protected RestrictingContract(String contractAddress, Web3j web3j, Credentials credentials, long chainId) {
        super(contractAddress, web3j, credentials, chainId);
    }

    protected RestrictingContract(String contractAddress, Web3j web3j, TransactionManager transactionManager) {
